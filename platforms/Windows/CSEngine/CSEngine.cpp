...
#pragma comment(lib, "../../../CSEngine/External/Squirrel/lib/Windows/squirrelD.lib")
#pragma comment(lib, "../../../CSEngine/External/Squirrel/lib/Windows/sqstdlibD.lib")
...
WCHAR szWindowClass[MAX_LOADSTRING]; // 기본 창 클래스 이름입니다.
									 ...
									 // Window dimensions
const GLuint WIDTH = 1280, HEIGHT = 400;
